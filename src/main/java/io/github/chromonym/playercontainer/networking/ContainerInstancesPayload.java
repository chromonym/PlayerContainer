...
public record ContainerInstancesPayload(BiMap<UUID, ContainerInstance<?>> containers, Map<GameProfile, UUID> players) implements CustomPayload {
    ...
    public static final CustomPayload.Id<ContainerInstancesPayload> ID = new CustomPayload.Id<ContainerInstancesPayload>(PlayerContainer.identifier("containers"));
